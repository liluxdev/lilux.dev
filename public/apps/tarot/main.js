...
var tarotDeck = {
    ...
    decks: {
        stedivination: {
            ...
            numberOfCards: 05,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/stedivination/back.png',
            root: '/apps/tarot/decks/stedivination/',
            prefixDigit: '0',
            separator: '',
            ext: 'png',
            majorArcanaSeed: 'a',
        ...
        goddessguidance: {
            ...
            numberOfCards: 44,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/goddessguidance/back.jpg',
            root: '/apps/tarot/decks/goddessguidance/',
            prefixDigit: '0',
            separator: '',
            ext: 'jpg',
            majorArcanaSeed: 'a',
        ...
        lotto: {
            ...
            numberOfCards: 90,
            onlyNumbers: true,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/rwpop1910/0-back.jpg',
            root: '/apps/tarot/decks/dorenvirtueangels/',
            prefixDigit: '',
            separator: '',
            ext: 'jpg',
        ...
        dvamc: {
            ...
            numberOfCards: 44,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/dorenvirtueangels/AAMichaelCARDS45.jpg',
            root: '/apps/tarot/decks/dorenvirtueangels/',
            prefixDigit: '',
            separator: '',
            ext: 'jpg',
        ...
        dva01: {
            ...
            numberOfCards: 44,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/dorenvirtueangels/carte_risposte_angeli_retro.jpg',
            root: '/apps/tarot/decks/dorenvirtueangels/',
            prefixDigit: '',
            separator: '',
            ext: 'jpg',
        ...
        rwpop1910: {
            ...
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/rwpop1910/0-back.jpg',
            root: '/apps/tarot/decks/rwpop1910/',
            prefixDigit: '0',
            separator: '-',
            ext: 'jpg',
            majorArcanaSeed: 'a',
        ...
        rwbw: {
            ...
            numberOfCards: 78,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/Back_of_the_card-512.png',
        ...
        marseilles: {
            ...
            numberOfCards: 78,
            onlyNumbers: false,
            backOfTheCardImgRelativeUrl: '/apps/tarot/decks/marseilles/back.jpg',
            root: '/apps/tarot/decks/marseilles/',
            prefixDigit: '0',
            separator: '',
            ext: 'jpg',
